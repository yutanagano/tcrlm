...
class ConfigReader:
    ...
    def get_training_delegate(self) -> TrainingDelegate:
        ...
        return self._instantiate_object_from_module_using_config(training_delegate_module, config)
    ...
    def instantiate_bert_on_device(self, device: torch.device) -> Bert:
        ...
        mlm_token_prediction_projector = (
            self._instantiate_mlm_token_prediction_projector()
        )
        vector_representation_delegate = (
            self._instantiate_vector_representation_delegate_for_self_attention_stack(
    ...
    def _instantiate_token_embedder(self) -> TokenEmbedder:
        ...
        return self._instantiate_object_from_module_using_config(
    ...
    def _instantiate_mlm_token_prediction_projector(
        self,
    ...
    def _instantiate_vector_representation_delegate_for_self_attention_stack(
    ...
    def _instantiate_batch_collator_for_tokeniser(
    ...
    def _instantiate_loss_functions(self) -> dict:
        ...
        loss_functions = {
            name: self._instantiate_object_from_module_using_config(
    ...
    def _instantiate_optimiser_for_model(
    ...
    def _instantiate_object_from_module_using_config(
