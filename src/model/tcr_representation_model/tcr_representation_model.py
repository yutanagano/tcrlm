...
class TcrRepresentationModel(TcrMetric):
    ...
    def calc_cdist_matrix(self, anchor_tcrs: DataFrame, comparison_tcrs: DataFrame) -> ndarray:
        ...
        comparison_tcr_representations = self.calc_vector_representations(comparison_tcrs)
        return self.calc_cdist_matrix_from_representations(anchor_tcr_representations, comparison_tcr_representations)
