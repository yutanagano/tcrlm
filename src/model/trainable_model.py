...
class ClTrainableModel(TrainableModel):
    def forward(
        self,
        tokenised_anchor_tcrs: Tensor,
        tokenised_positive_pair_tcrs: Tensor,
        tokenised_and_masked_tcrs: Tensor,
    ) -> Tuple[Tensor]:
        anchor_tcr_representations = self.bert.get_vector_representations_of(
            tokenised_anchor_tcrs
        )
        positive_pair_tcr_representations = self.bert.get_vector_representations_of(
            tokenised_positive_pair_tcrs
        )
