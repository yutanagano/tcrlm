...
VDJDB_DATA_PATH = "/home/yutanagano/UCLOneDrive/MBPhD/projects/tcr_embedder/data/preprocessed/vdjdb/evaluation_alphabeta.csv"
...
class BenchmarkingPipeline:
    def __init__(self) -> None:
        ...
        def transform_df(df):
            ...
            df = df[["v_a_gene", "cdr3_a_aa", "v_b_gene", "cdr3_b_aa", "Epitope"]]
            df[["v_a_gene", "v_b_gene"]] = df[["v_a_gene", "v_b_gene"]].applymap(
        ...
        dash_data = dash_data[
            ["v_a_gene", "cdr3_a_aa", "v_b_gene", "cdr3_b_aa", "epitope", "count"]
        ]
        ...
        self.benchmark_dir = PROJECT_DIR / "benchmarks" / "tcrdist"
    ...
    def main(self) -> None:
        ...
        for ds_name, ds_df in self.ep_data.items():
            ...
            cdist = tr.pw_beta.astype(np.float32) + tr.pw_alpha.astype(np.float32)
