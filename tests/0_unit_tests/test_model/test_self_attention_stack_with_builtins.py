...
def test_forward(self_attention_stack_with_builtins: SelfAttentionStackWithBuiltins, mock_token_embeddings, mock_padding_mask):
    result = self_attention_stack_with_builtins.forward(mock_token_embeddings, mock_padding_mask)
...
def test_get_token_embeddings_at_penultimate_layer(self_attention_stack_with_builtins: SelfAttentionStackWithBuiltins, mock_token_embeddings, mock_padding_mask):
    result = self_attention_stack_with_builtins.get_token_embeddings_at_penultimate_layer(mock_token_embeddings, mock_padding_mask)
