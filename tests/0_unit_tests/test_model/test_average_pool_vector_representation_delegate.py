...
def test_get_vector_representations_of(mock_token_embeddings, mock_padding_mask):
    ...
    vector_representation_delegate = AveragePoolVectorRepresentationDelegate(self_attention_stack)
    
    result = vector_representation_delegate.get_vector_representations_of(mock_token_embeddings, mock_padding_mask)
