...
def model_template():
    ...
    vector_embedding_delegate = AveragePoolVectorRepresentationDelegate(self_attention_stack)

    bert = Bert(token_embedder, self_attention_stack, mlm_token_prediction_projector, vector_embedding_delegate)
